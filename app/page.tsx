...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-950 via-purple-950 to-slate-900 flex items-center justify-center p-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-7xl font-extrabold bg-linear-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent">
              Welcome to Chat
            </h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Connect instantly with friends, family, and colleagues. Simple, fast, and secure messaging for everyone.
            </p>
          </div>
