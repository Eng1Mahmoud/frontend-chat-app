  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen relative overflow-hidden bg-slate-950 text-white w-full">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-600/20 rounded-full blur-[140px] animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-[40%] left-[50%] w-[30%] h-[30%] bg-pink-500/10 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }} />
      </div>

      {/* Floating particles */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[20%] left-[10%] w-2 h-2 bg-indigo-400/40 rounded-full animate-bounce" style={{ animationDuration: '3s', animationDelay: '0s' }} />
        <div className="absolute top-[60%] right-[15%] w-2 h-2 bg-purple-400/40 rounded-full animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }} />
        <div className="absolute bottom-[30%] left-[20%] w-2 h-2 bg-pink-400/40 rounded-full animate-bounce" style={{ animationDuration: '3.5s', animationDelay: '0.5s' }} />
      </div>
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto px-6">
        ...
        <div className="mb-10 relative inline-block">
          <div className="relative">
            ...
            <div className="relative w-28 h-28 mx-auto bg-linear-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-indigo-500/30 transform hover:scale-110 hover:rotate-6 transition-all duration-500">
              <MessageSquareText className="w-14 h-14 text-white drop-shadow-lg" strokeWidth={1.5} />
              {/* floating decorative elements */}
              <div className="absolute -top-6 -right-6 w-10 h-10 bg-purple-500/20 rounded-full animate-bounce backdrop-blur-md border border-purple-400/30" style={{ animationDelay: '0.1s', animationDuration: '2s' }} />
              <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-indigo-500/20 rounded-full animate-bounce backdrop-blur-md border border-indigo-400/30" style={{ animationDelay: '0.3s', animationDuration: '2.5s' }} />
              <div className="absolute top-0 left-0 w-6 h-6 bg-pink-500/20 rounded-full animate-bounce backdrop-blur-md border border-pink-400/30" style={{ animationDelay: '0.5s', animationDuration: '3s' }} />
            </div>
          </div>
        ...
        <div className="mb-10 space-y-5">
          ...
          <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-lg mx-auto">
            ...
            <span className="block mt-2 text-indigo-300 font-medium">Secure, fast, and beautiful.</span>
          </p>
        </div>
