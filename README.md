...
2.  **Clone the Repository**:
    ```bash
    git clone https://github.com/Eng1Mahmoud/frontend-chat-app.git
...
- **`UserList.tsx`**: Renders individual user items in the list, displaying unread message counts.
...
- `unreadCounts`: Tracks the number of unread messages for each user.
